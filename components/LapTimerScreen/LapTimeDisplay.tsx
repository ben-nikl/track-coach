...
const styles = StyleSheet.create({
    ...
    time: {fontSize: 64, fontWeight: '800', letterSpacing: -2, textAlign: 'center', fontVariant: ['tabular-nums']},
    delta: {fontSize: 22, fontWeight: '700', marginTop: 4, textAlign: 'center', fontVariant: ['tabular-nums']},
});
